...
export default function Navbar() {
    ...
    return (
        <header className={`fixed top-0 left-0 w-full bg-white z-50 ${showMenu ? "h-screen" : "h-max"} px-7.5 py-4 lg:px-10 xl:px-20 lg:py-6`}>
                ...
                <div className="lg:hidden bg-white animate-fadeIn">
                    <ul className="flex flex-col space-y-6 -mx-7.5 mt-8 font-medium">
                        <li className="border-b-[0.6px] border-[#D9D9D9] pb-3.5">
                            <Link href="/" onClick={toggleMenu} className="px-7.5">Home</Link>
                        </li>
                        <li className="border-b-[0.6px] border-[#D9D9D9] pb-3.5">
                            <Link href="/about" onClick={toggleMenu} className="px-7.5">About</Link>
                        </li>
                        <li className="border-b-[0.6px] border-[#D9D9D9] pb-3.5">
                            <Link href="/services" onClick={toggleMenu} className="px-7.5">Services</Link>
                        </li>
                        <li className="border-b-[0.6px] border-[#D9D9D9] pb-3.5">
                            <Link href="/blog" onClick={toggleMenu} className="px-7.5">Blog</Link>
                        </li>
                    </ul>
