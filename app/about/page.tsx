  ...
  return (
    <div className="flex flex-col bg-[#F5F8FA]">
      ...
      <section className="flex flex-col gap-6 lg:gap-0 lg:flex-row lg:w-full lg:justify-between py-16 px-7.5 lg:px-10 xl:px-20">
        <div className="flex flex-col gap-6 lg:w-1/2">
          ...
          <p className="font-normal text-[#333740] text-center lg:text-left text-xs sm:text-sm lg:text-base">
            ...
            operations moving. Our journey is defined by a commitment to
            international quality standards, competitive pricing and a
            people-first approach that ensures every client receives value and
            peace of mind.
          </p>
        ...
        <div className="flex flex-col lg:hidden gap-2.5 mx-auto">
          ...
          <div className="bg-[#F12328] rounded-xl px-5 py-7">
            <div className="flex flex-col gap-2.5">
              <h3 className="font-bold text-white text-sm sm:text-lg md:text-xl">
                Our Mission
              </h3>

              <p className="font-normal text-white text-xs md:text-sm">
                To provide high-quality tyres, batteries, and lubricants at
                competitive prices, while ensuring a seamless, reliable, and
          ...
          <div className="bg-[#16172B] rounded-xl px-5 py-7">
            <div className="flex flex-col gap-2.5">
              ...
              <p className="font-normal text-white text-xs md:text-sm">
                To become Africa&#39;s most reputable and reliable partner in
                the automotive industry, renowned for delivering exceptional
                value, safety, and customer-centric solutions across corporate
                and public organizations within Africa.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="flex flex-col gap-10 py-14 lg:py-20 px-7.5 lg:px-10 xl:px-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-7 lg:gap-10 w-full">
          {coreValues.map((value, index) => (
            <div
              key={index}
              className="bg-[white] rounded-2xl border border-[#C7C7CC] px-8 py-4 md:px-9 md:py-5"
            >
              <div className="flex flex-col gap-3.5">
                ...
                <h3 className="font-bold text-[#222222] text-lg md:text-2xl">
                  {value.title}
                </h3>

                <p className="font-normal text-[#333333] text-xs md:text-sm leading-5 lg:leading-6 tracking-normal">
                  {value.description}
                </p>
              </div>
            </div>
      ...
      <section className="flex flex-col gap-10 py-14 lg:py-20 px-7.5 lg:px-10 xl:px-20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-10 lg:gap-18 mx-auto">
          {clientsLogos.map((logo, index) => (
            <div
              key={index}
              className="flex bg-white rounded-xl py-9.5 px-6 shadow-sm items-center justify-center"
            >
              <Image
                src={logo.image}
                alt={logo.alt}
